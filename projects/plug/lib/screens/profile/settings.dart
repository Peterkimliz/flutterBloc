...
import 'package:plug/screens/bank_setup.dart';
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      const CommonText(
                                          ...
                                          color: blackColor),
                                      Obx(() => Switch(
                                          value: userController.currentProfile.value!.showComments!,
                                          onChanged: (val) {
                                            userController.currentProfile.value!.showComments= val;
                                            userController.currentProfile.refresh();
                                            authController.updateSingleItem(
                                                body: {"showComments": val},
                                                id: FirebaseAuth.instance.currentUser!.uid);
