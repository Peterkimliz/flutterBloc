...
Widget receiverOfferWidget({required Chat chatData,
  required context,
      ...
      chatData.action == "accept" &&
          ...
          firstAction: () {
              ...
              finished: true,
                ...
                chatController
                    .cancelOffer(FirebaseAuth.instance.currentUser!.uid, () {
          ...
          secondAction: () async {
            ...
            chatController.deleteRequest(id: chatData.requestId!);
          },
          showSecondButton: true,
          showFirstButton: true)
...
sendWorkCompleteMessage({required Chat chatData, required String uid}) {
  ...
  chatController.updateChatByLoop(
      uid: uid, param: "workingProvider", body: {"action": "workingCompleted"});
...
Widget actionButton({required firstTitle,
  required Chat chatData,
  required Function firstAction,
  required Color firstBgColor,
  required context,
