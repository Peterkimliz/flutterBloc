                        ...
                        Row(
                          ...
                          children: [
                            ...
                            CommonText(
                              ...
                              text:
                                  "${calculateDistance(
                                      lat1: userModel.geoPoint!.latitude.toInt(),
                                      lon1: userModel.geoPoint!.longitude.toInt(),
                                      lat2: serviceController.position.value!.latitude!.toInt(),
                                      lon2: serviceController.position.value!.latitude!.toInt()).toString()} km away",
                              fontFamily: "RedHatLight",
                            ),
                          ],
                        ),
